...
from nextface.face_analyser import pre_check, clear_face_analyser, get_one_face
from nextface.typing import Face
from nextface.vision import read_static_image
...
def before_each() -> None:
	nextface.globals.face_detector_score = 0.5
	nextface.globals.face_landmarker_score = 0.5
	nextface.globals.face_recognizer_model = 'arcface_inswapper'
	clear_face_analyser()


def test_get_one_face_with_retinaface() -> None:
	nextface.globals.face_detector_model = 'retinaface'
	nextface.globals.face_detector_size = '320x320'
...
def test_get_one_face_with_scrfd() -> None:
	nextface.globals.face_detector_model = 'scrfd'
...
def test_get_one_face_with_yoloface() -> None:
	nextface.globals.face_detector_model = 'yoloface'
	nextface.globals.face_detector_size = '640x640'
