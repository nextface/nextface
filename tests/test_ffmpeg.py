...
from nextface.filesystem import get_temp_directory_path, create_temp, clear_temp
from nextface.download import conditional_download
from nextface.ffmpeg import extract_frames, read_audio_buffer
...
def before_each() -> None:
	...
	nextface.globals.temp_frame_format = 'jpg'
...
def test_extract_frames_with_trim_start() -> None:
	nextface.globals.trim_frame_start = 224
	data_provider =\
	[
...
def test_extract_frames_with_trim_start_and_trim_end() -> None:
	nextface.globals.trim_frame_start = 124
