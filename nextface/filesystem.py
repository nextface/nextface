...
TEMP_DIRECTORY_PATH = os.path.join(tempfile.gettempdir(), 'nextface')
...
def get_temp_frames_pattern(target_path : str, temp_frame_prefix : str) -> str:
	...
	return os.path.join(temp_directory_path, temp_frame_prefix + '.' + nextface.globals.temp_frame_format)
