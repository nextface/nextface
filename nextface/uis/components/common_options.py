...
from nextface.uis import choices as uis_choices
...
def update(common_options : List[str]) -> None:
	nextface.globals.keep_temp = 'keep-temp' in common_options
	nextface.globals.skip_audio = 'skip-audio' in common_options
	nextface.globals.skip_download = 'skip-download' in common_options
